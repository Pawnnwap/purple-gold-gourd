...
- **非事实依据。** 本工具生成的所有内容——包括人格脚本、合成语音、对话回复及文档——均由大语言模型和自动语音识别系统产生，可能存在不准确、不完整或误导性信息。任何由本工具生成的内容均不应被视为事实陈述、权威观点，或对任何真实人物立场的真实代表。
- **创作者内容。** 本工具仅访问平台上公开可获取的音视频内容，不绕过任何付费墙、鉴权机制或访问控制。用户须自行确保其使用行为符合相关平台服务条款及适用的著作权法律法规。
- **无意冒充或侵权。** 本工具生成的人格模拟，无意冒充、诽谤、误导或以任何方式伤害任何个人。这些模拟仅是基于公开语料的示意性近似，并非对真实人物身份或观点的真实呈现。
- **用户责任。** 用户对本工具生成的内容及其后续任何形式的发布、传播或使用，承担全部责任。本仓库维护者对因此产生的任何直接或间接后果不承担任何法律责任。
- **无隶属关系。** 本项目与哔哩哔哩、YouTube 及任何可能被处理内容的创作者均无任何隶属或合作关系。
