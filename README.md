...
- **No ground truth.** All output — persona scripts, synthesized speech, chat replies, and generated documents — is produced by large language models and automatic speech recognition systems. It may be inaccurate, incomplete, or misleading. Nothing produced by this tool should be treated as factual, authoritative, or representative of the views of any real person.
- **Creator content.** This tool accesses only publicly available audio and video. It does not circumvent paywalls, authentication walls, or any access controls. Users are solely responsible for ensuring their use complies with the terms of service of any platform they interact with and with applicable copyright law.
- **No endorsement or impersonation intent.** The persona simulations created by this tool are not intended to impersonate, defame, mislead, or otherwise harm any individual. They are illustrative approximations based on publicly available speech, not authentic representations of any real person's identity or opinions.
- **User responsibility.** Any content generated by this tool and subsequently published, distributed, or used for any purpose is the sole responsibility of the user. The maintainers of this repository accept no liability for any direct or indirect consequences arising from such use.
- **No affiliation.** This project has no affiliation with Bilibili, YouTube, or any creator whose content may be processed.
